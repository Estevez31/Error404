...
class WebRequestHandler(BaseHTTPRequestHandler):
    ...
    def search(self):
        ...
        h2_elements = soup.find_all('h2')  # Buscar todos los elementos h2
    
        matching_books = []
        for h2_element in h2_elements:
            a_element = h2_element.find('a')  # Buscar el elemento <a> dentro de cada elemento h2
            if a_element:
                title = a_element.text.lower()  # Obtener el texto del título
                link = a_element['href']  # Obtener el enlace del libro
